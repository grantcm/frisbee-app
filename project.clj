(defproject frisbee-spa "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot frisbee-spa.core
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "frisbee-spa.core/mount-components"}
                     :compiler
                     {:main "frisbee-spa.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
